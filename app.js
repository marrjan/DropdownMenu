...
const dropdownTitleIcon = document.querySelector(".menu-title-icon");
const dropdownTitle = document.querySelector(".menu-title");
const dropdownList = document.querySelector(".menu-list");
...
const listItemTemplate = (text, translateValue) => {
  return `
    <li class="menu-list-item">
      <button class="menu-button list-button" data-translate-value="${translateValue}%">
